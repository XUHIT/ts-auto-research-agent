...
run_0051 baseline_anchor       DLinear     rmse       0.59827763 0          continue
run_0052 strong_reference      PatchTST    rmse       0.58627319 0.01200444 continue
run_0053 innovation_candidate  CalDLinear  rmse       0.59605795 0.00221968 continue

Next: Deepen `CalDLinear` with ablations and more datasets before making a paper-level claim.
Report: /home/xu/ts-auto-research-agent/research_state/showcase.md
```
